...
<!-- MENU SELECTOR -->
<ul>
  <li :id="`${resturant.name}`" class="grid grid-cols-1 gap-4" v-for="(resturant,index) in resturants" :key="index" >
    <!-- LOGO -->
    ...
    <!-- SECOND MENU -->
    <!-- <div class="grid grid-cols-1 gap-24 mx-auto w-5/6 md:w-3/6 shadow-lg rounded-lg my-12 py-12 px-4 md:px-28" >
