...
<div class="flex flex-col gap-24 md:gap-0 w-5/6 mx-auto md:w-full" >
  ...
  <div class="flex flex-col items-center md:flex-row mx-auto md:ml-32 md:w-3/4 gap-10" >
    <nuxt-image class="w-48 object-contain" src="images/extramogelijkhedenlocatie/1.png" alt="food image" />
  ...
  <div class="flex flex-col md:w-full md:flex-row items-center h-96 gap-10" >
    <div class="relative flex items-center" style="height:100%;width:20rem" >
      <nuxt-image class="relative md:absolute md:-left-1/4 " style="width:100%;width:40rem;max-width:auto;" src="images/extramogelijkhedenlocatie/2.png" alt="image of food 2" />
    </div>
